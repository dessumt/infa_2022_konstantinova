...
# Функция описывает характеристики шарика и создает новый, где х, у - координаты центра шарика, r - радиус, color - цвет
def new_ball():
    global x, y, r
    x = randint(100, 700)
    y = randint(100, 500)
...
# Эта функция создает n штук шариков с координатами, где n - количество шариков
def create_ball(n):
        c = []
        for i in range(n):
            c.append((new_ball()))
